      ...
      <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        ...
        <div class="c-subheader px-3">
          <ol class="breadcrumb border-0 m-0">
            ...
            <div class="dropdown dropdown-menu-left my-1">
                ...
                <div class="dropdown-menu notific" aria-labelledby="notificationsDropdown">
                    @php
                        $notifications = null;
                    ...
                    @if($unreadNotifications)
                        @foreach ($unreadNotifications as $notification)
                            <a class="dropdown-item unread-notification" href="#">{{ $notification->data['message'] }}</a>
                        @endforeach
                    @endif
                    @if($notifications)
                        @foreach ($notifications as $notification)
                            <a class="dropdown-item read-notification" href="#">{{ $notification->data['message'] }}</a>
                        @endforeach
                    @endif
